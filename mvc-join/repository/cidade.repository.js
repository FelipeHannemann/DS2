...
const query = 'SELECT c.id AS cidade_id, c.nome AS cidade_nome, e.id AS estado_id, ' +
                ' e.nome AS estado_nome, e.sigra AS estado_sigla FROM cidade AS c '+ 
                'INNER JOIN estado AS e ON e.id = c.estado_id';
